...
- Use the `/blogkit.` command prefix to easily discover Spec Kit-related commands.
...
- All command files now prefixed with `blogkit.` (e.g., `blogkit.blog.md`, `blogkit.plan.md`) for better discoverability and differentiation in IDE/CLI command palettes and file explorers
