# /blogkit.constitution Command

**Purpose**: Create or update the blog governance principles in the project constitution.

**Usage**: Run `/blogkit.constitution` in Claude Code to establish or update blog-specific principles.
...
**Reference**: See `refs/1_principles_for_constitution.md` for guidance on blog principles.
